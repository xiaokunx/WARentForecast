...
# using google goecoder API to query longitude and latitude of city/neighborhood
latlong = function(City, Neighborhood) {
  apicall = sprintf("http://maps.google.com/maps/api/geocode/xml?sensor=false&address=%s", Neighborhood)
  xml = XML::htmlParse(apicall)
